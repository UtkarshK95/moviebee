export default function About() {
  return (
    <div className="max-w-6xl mx-auto space-y-4 p-4">
      ...
      <p>
        This webapp lets you search for your favourite movies with a Trending
        and Top Rated curated list of movies{" "}
      </p>
      <p>This app is built using NextJS 13 and Tailwind CSS 3</p>
      <h1 className="text-2xl font-medium text-amber-500">
        About the developer
      </h1>
      <p>Hi, I am Utkarsh.</p>
      <p>
        I am a Senior Software Engineer with experience in creating scalable and
        responsive web and mobile apps
      </p>
      <p>
        Stack - HTML5, CSS3, SASS, Bootstrap, Tailwind, JavaScript, TypeScript,
        ReactJS, NextJS, React-Native Redux, Jest, Enzyme, RTL, MongoDB,
        ExpressJS, NodeJS
      </p>
      <h1 className="text-2xl font-medium text-amber-500">Contact</h1>
      <span>
